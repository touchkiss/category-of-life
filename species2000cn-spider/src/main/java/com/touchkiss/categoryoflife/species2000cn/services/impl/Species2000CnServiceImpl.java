...
public class Species2000CnServiceImpl implements Species2000CnService {
    ...
    public List<TreeItemResponse> browse(String id) {
        ...
        headers.add(new BasicHeader("X-CSRF-TOKEN", "62b11a75-93af-4961-aa0d-696479dc5ab1"));
        headers.add(new BasicHeader("Cookie", "JSESSIONID=BDF64CD5C3C78E3DABD5D739A1AA6A6D"));
        try {

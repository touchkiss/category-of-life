...
(function () {
    ...
    (function () {
        ...
        dojo.version = {
            major: 1, minor: 3, patch: 2, flag: "", revision: rev ? +rev[0] : NaN, toString: function () {
                with (d.version) {
    ...
    if (!dojo._hasResource["dojo._base.declare"]) {
        ...
        dojo.mixin(dojo.declare, {
            _delegate: function (_d3, _d4) {
                ...
                _construct: function (_dc) {
                    var c = _dc.callee, s = c.superclass, ct = s && s.constructor, m = c.mixin,
                        mct = m && m.constructor, a = _dc, ii, fn;
                    if (a[0]) {
                        if (((fn = a[0].preamble))) {
                            a = fn.apply(this, a) || a;
                        }
    ...
    if (!dojo._hasResource["dojo._base.array"]) {
        ...
        (function () {
            ...
            dojo.mixin(dojo, {
                indexOf: function (_159, _15a, _15b, _15c) {
    ...
    if (!dojo._hasResource["dojo._base.event"]) {
        ...
        (function () {
            ...
            if (dojo.isIE) {
                ...
                if (!dojo.config._allow_leaks) {
                    _1cb = iel = dojo._ie_listener = {
                        handlers: [], add: function (_1de, _1df, _1e0) {
        ...
        if (dojo.isIE) {
            dojo._ieDispatcher = function (args, _219) {
                var ap = Array.prototype, h = dojo._ie_listener.handlers, c = args.callee,
    ...
    if (!dojo._hasResource["dojo._base.html"]) {
        ...
        (function () {
            ...
            dojo._getBorderExtents = function (n, _272) {
                var ne = "none", s = _272 || gcs(n), bl = (s.borderLeftStyle != ne ? px(n, s.borderLeftWidth) : 0),
            ...
            dojo._getMarginExtents = function (n, _27d) {
                var s = _27d || gcs(n), l = px(n, s.marginLeft), t = px(n, s.marginTop), r = px(n, s.marginRight),
            ...
            dojo._getContentBox = function (node, _28f) {
                var s = _28f || gcs(node), pe = d._getPadExtents(node, s), be = d._getBorderExtents(node, s),
            ...
            dojo._setMarginBox = function (node, _2aa, _2ab, _2ac, _2ad, _2ae) {
                var s = _2ae || gcs(node), bb = d._usesBorderBox(node),
                    pb = bb ? _2b2 : d._getPadBorderExtents(node, s);
                if (d.isWebKit) {
            ...
            var _2e8 = {}, _ctr = 0, _2ea = dojo._scopeName + "attrid",
                _2eb = {col: 1, colgroup: 1, table: 1, tbody: 1, tfoot: 1, thead: 1, tr: 1, title: 1};
            ...
            var _2ff = {
                ...
                col: ["table", "colgroup"],
                li: ["ul"]
            }, _300 = /<\s*([\w\:]+)/, _301 = {}, _302 = 0, _303 = "__" + d._scopeName + "ToDomId";
            ...
            d._toDom = function (frag, doc) {
                ...
                frag += "";
                var _309 = frag.match(_300), tag = _309 ? _309[1].toLowerCase() : "", _30b = _301[_308], wrap, i, fc,
                    df;
                if (_309 && _2ff[tag]) {
                    wrap = _2ff[tag];
        ...
        (function () {
            ...
            dojo.extend(dojo.NodeList, {
                concat: function (item) {
                    ...
                    var c = d.isString(_359) ? d._toDom(_359, this[0] && this[0].ownerDocument) : _359, i,
                        l = this.length - 1;
                    for (i = 0; i < l; ++i) {
        ...
        (function () {
            ...
            dojo.anim = function (node, _52d, _52e, _52f, _530, _531) {
                return d.animateProperty({
                    node: node,
                    duration: _52e || d._Animation.prototype.duration,
                    properties: _52d,
                    easing: _52f,
                    onEnd: _530
                }).play(_531 || 0);

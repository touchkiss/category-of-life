  ...
  <div class="index-vue">
    ...
    <aside :class="asideClassName">
      ...
      <div class="logo-c">
        ...
        <span v-show="isShowAsideTitle">物种图鉴</span>
      </div>
      <!-- 菜单栏 -->
      <Menu
        ref="asideMenu"
              ...
              <Submenu v-if="subItem.children" :name="index + '-' + i">
                ...
                >
                  <Icon
                    ...
                    :type="threeItem.type"
                  />
                  <span v-if="!threeItem.hidden" v-show="isShowAsideTitle">{{
                    threeItem.text
                  }}</span>
                </MenuItem>
              </Submenu>
    ...
    <section class="sec-right">
        ...
        <header>
          <div class="h-left">
            ...
            <el-breadcrumb separator="/" class="crumbs">
              ...
              <el-breadcrumb-item v-for="item in crumbs" :key="item">{{ item }}
              </el-breadcrumb-item>
              <!--              </transition-group>-->
            </el-breadcrumb>
          </div>
          <div class="h-right">
            <!-- 消息 -->
            <div class="notice-c" title="查看新消息" @click="info">
        ...
        <div class="div-tags">
          <ul class="ul-c">
            ...
            >
              ...
              <Icon size="16" type="md-close" @click="closeTag(index)" />
            </li>
          </ul>
          <!-- 标签栏相关功能 -->
          <div class="div-icons">
            <div class="refresh-c" title="刷新当前标签页" @click="reloadPage">
      ...
      <div class="main-content">
        <div class="view-c">
          ...
          <div v-show="showLoading" class="loading-c">
            <Spin size="large"></Spin>
          </div>
        </div>
      </div>
      <el-footer>2020 © Touchkiss all rights reserved.</el-footer>
    </section>
  </div>
</template>
...
export default {
  ...
  watch: {
    $route(to) {
      ...
      setTimeout(() => {
        this.crumbs = this.paths[name].split('/')
      }, 0)
    }
  },
  created() {
  ...
  mounted() {
    ...
    this.crumbs = this.paths[this.$route.name].split('/')
    // 监听窗口大小 自动收缩侧边栏

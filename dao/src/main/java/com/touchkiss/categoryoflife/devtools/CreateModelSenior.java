package com.touchkiss.categoryoflife.devtools;
...
public class CreateModelSenior {
    public static final String LINE_SEPERATOR = "";
    public final static String BASE_PACKAGE = "com.touchkiss.categoryoflife.";
    public final static String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/categoryoflife?characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true";
    ...
    public static void main(String[] args) {
        ...
        CreateModelSenior ctfile = new CreateModelSenior();

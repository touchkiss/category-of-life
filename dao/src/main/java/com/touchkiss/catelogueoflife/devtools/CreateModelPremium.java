package com.touchkiss.catelogueoflife.devtools;
...
public class CreateModelPremium {
    ...
    public final static String BASE_PACKAGE = "com.touchkiss.catelogueoflife.";
    public final static String JDBC_URL = "jdbc:mysql://112.126.56.26:3306/categoryoflife?characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true";
    ...
    public static void main(String[] args) {
        ...
        String filepath = "D:\\life";
        List<TableInfo> tableInfoList = new ArrayList<>();

//        tableInfoList.add(new TableInfo("LifeCategory", "t_life_category", "life", "life"));
//        tableInfoList.add(new TableInfo("SourceDatabase", "t_source_database", "life", "life"));
//        tableInfoList.add(new TableInfo("LifeCategorySourceDatabase", "t_life_category_source_database", "life", "life"));
//        tableInfoList.add(new TableInfo("Species", "t_species", "species", "species"));
//        tableInfoList.add(new TableInfo("SpeciesCommonName", "t_species_common_name", "species", "species"));
//        tableInfoList.add(new TableInfo("SpeciesCommonNameReferences", "t_species_common_names_references", "species", "species"));
//        tableInfoList.add(new TableInfo("SpeciesRecordScrutiny", "t_species_record_scrutiny", "species", "species"));
//        tableInfoList.add(new TableInfo("SpeciesReferences", "t_species_references", "species", "species"));
//        tableInfoList.add(new TableInfo("SpeciesSynonyms", "t_species_synonyms", "species", "species"));
//        tableInfoList.add(new TableInfo("Translate", "t_translate", "translate", "translate"));
        tableInfoList.add(new TableInfo("KsRecVideo", "ks_rec_video", "kuaishou", "kuaishou"));
...
//                ctfile.createItemReadonly(filepath, tableInfo.getBeanName(), columns, fields, comments);
    ...
    private void createRestController(String path, String bean, String module, String ptype, List<String> fields, String requestPath, String autoIncrementColumn) throws Exception {
        ...
        myFile.println("public class " + bean + "Controller extends BaseController {");
